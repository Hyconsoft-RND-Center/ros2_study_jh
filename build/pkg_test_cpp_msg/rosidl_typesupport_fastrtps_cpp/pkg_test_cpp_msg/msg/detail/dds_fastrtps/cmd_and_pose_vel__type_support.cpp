...
#include "pkg_test_cpp_msg/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pkg_test_cpp_msg::msg::CmdAndPoseVel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pkg_test_cpp_msg::msg::CmdAndPoseVel & ros_message)
{
  // Member: cmd_vel_linear
  cdr >> ros_message.cmd_vel_linear;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pkg_test_cpp_msg::msg::CmdAndPoseVel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pkg_test_cpp_msg::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg_test_cpp_msg::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  return &pkg_test_cpp_msg::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg_test_cpp_msg, msg, CmdAndPoseVel)() {
  return &pkg_test_cpp_msg::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
