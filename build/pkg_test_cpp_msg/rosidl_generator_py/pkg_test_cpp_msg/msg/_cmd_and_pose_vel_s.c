...
bool pkg_test_cpp_msg__msg__cmd_and_pose_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pkg_test_cpp_msg.msg._cmd_and_pose_vel.CmdAndPoseVel", full_classname_dest, 52) == 0);
  }
  pkg_test_cpp_msg__msg__CmdAndPoseVel * ros_message = _ros_message;
  {  // cmd_vel_linear
...
PyObject * pkg_test_cpp_msg__msg__cmd_and_pose_vel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pkg_test_cpp_msg.msg._cmd_and_pose_vel");
