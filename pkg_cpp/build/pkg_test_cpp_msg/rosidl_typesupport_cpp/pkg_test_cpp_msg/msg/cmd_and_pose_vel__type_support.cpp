...
static const _CmdAndPoseVel_type_support_symbol_names_t _CmdAndPoseVel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg_test_cpp_msg, msg, CmdAndPoseVel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pkg_test_cpp_msg, msg, CmdAndPoseVel)),
  }
};
...
{
  return &::pkg_test_cpp_msg::msg::rosidl_typesupport_cpp::CmdAndPoseVel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pkg_test_cpp_msg, msg, CmdAndPoseVel)() {
  return get_message_type_support_handle<pkg_test_cpp_msg::msg::CmdAndPoseVel>();
}
